...
function garnier_enqueue_styles() {
    wp_enqueue_style('garnier-style', get_template_directory_uri() . '/css/style.css');
}
add_action('wp_enqueue_scripts', 'garnier_enqueue_styles');
